export const HOME = { label: 'AppyDave', link: '/' };

export const AREA = [
  { label: 'Ruby', link: '/ruby' },
  { label: 'AstroJS', link: '/astrojs' },
  { label: 'Twitter', link: 'https://twitter.com/99IdeasMen', attributes: { target: '_blank' } },
  { label: 'GitHub', link: 'https://github.com/klueless-io' , attributes: { target: '_blank' } }
];
